...
void CGameContext::OnClientEnter(int ClientID)
{
	...
	if(((CServer *) Server())->m_aPrevStates[ClientID] < CServer::CClient::STATE_INGAME)
	{
		...
		SendChatTarget(ClientID, "TBlock Mod Version 1.2"/*GAME_VERSION*/);
		SendChatTarget(ClientID, "please visit http://teecity.ir or say /info for more info");
		...
		else if (MsgID == NETMSGTYPE_CL_EMOTICON && !m_World.m_Paused)
		{
			...
			if(pChr && g_Config.m_SvEmotionalTees && pPlayer->m_EyeEmote)
			{
				...
				case EMOTICON_WTF:
						...
						CreateSound(pChr->m_Pos, SOUND_BODY_LAND);
						break;
				...
				case EMOTICON_SUSHI:
						...
						CreateSound(pChr->m_Pos, SOUND_PLAYER_PAIN_SHORT);
						break;
				case EMOTICON_DEVILTEE:
				case EMOTICON_SPLATTEE:
				case EMOTICON_ZOMG:
						pChr->SetEmoteType(EMOTE_ANGRY);
						CreateSound(pChr->m_Pos, SOUND_PLAYER_PAIN_LONG);
						break;
					default:
